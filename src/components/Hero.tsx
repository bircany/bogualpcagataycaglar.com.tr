  ...
  <section id="hero" className="hero-gradient relative min-h-screen overflow-hidden pt-36 sm:pt-40 lg:pt-44">
    ...
    <div className="relative mx-auto grid min-h-[calc(100vh-6rem)] max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_.9fr] lg:px-8 lg:py-24">
      <div className="text-center lg:text-left order-2 lg:order-1">
        ...
        <div className="flex flex-col justify-center gap-3 sm:flex-row lg:justify-start animate-blur-in [animation-delay:400ms]">
          <a href="https://wa.me/905070314041" target="_blank" rel="noreferrer" onClick={() => trackContactConversion("whatsapp", "hero")}>
          ...
          <a href="#services">
            <Button variant="outline" size="lg" className="btn-outline-cta w-full sm:w-auto">
              Çalışma Alanları <ArrowUpRight className="ml-2 h-5 w-5" />
            </Button>
          </a>
        </div>
      </div>
    ...
    <a href="#services" className="absolute bottom-6 left-1/2 hidden -translate-x-1/2 text-primary-dark lg:block" aria-label="Aşağı kaydır">
